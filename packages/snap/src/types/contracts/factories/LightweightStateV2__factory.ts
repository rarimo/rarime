...
export class LightweightStateV2__factory {
  static readonly abi = _abi;
  static createInterface(): LightweightStateV2Interface {
    return new utils.Interface(_abi) as LightweightStateV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LightweightStateV2 {
    return new Contract(address, _abi, signerOrProvider) as LightweightStateV2;
  }
}
